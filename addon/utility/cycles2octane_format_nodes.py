                ...
                if link.to_node.bl_idname == "ShaderNodeMixShader" or link.to_node.bl_idname == "ShaderNodeAddShader":
                    ...
                    if translucent_node and join_node:
                        ...
                        if translucent_node.inputs["Color"].links:
                            ...
                            create_node_link(
                                node.id_data, node.inputs["Transmission Weight"], translucent_node.inputs["Color"].links[0].from_socket)
                            ...
                            create_node_link(
                                input_rgb.id_data, node.inputs["Transmission Weight"], input_rgb.outputs["Color"])
